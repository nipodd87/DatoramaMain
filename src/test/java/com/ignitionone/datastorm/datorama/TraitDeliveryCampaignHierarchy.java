 ...
 */
public class TraitDeliveryCampaignHierarchy extends ApiBaseClass {
    ...
    public void traitLevelCampaignTest() throws Exception {
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getTraitDeliveryLevelCampaign(reportStartDate, reportEndDate), token);
