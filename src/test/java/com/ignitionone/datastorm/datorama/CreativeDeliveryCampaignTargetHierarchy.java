...
public class CreativeDeliveryCampaignTargetHierarchy extends BaseClass {
    ...
    public void creativeLevelCampaignTest() throws Exception {
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeDeliveryLevelCampaignTarget(reportStartDate, reportEndDate, brandId), token);
