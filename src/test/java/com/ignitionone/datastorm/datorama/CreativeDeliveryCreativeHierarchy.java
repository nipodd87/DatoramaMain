...
public class CreativeDeliveryCreativeHierarchy extends ApiBaseClass {
    ...
    private static final String REPORT_HEADER = "Compare Creative Level Creative Hierarchical counts between SQL NAN and Datorama Stream Using API";
    ...
    public void creativeLevelCampaignTest() throws Exception {
        ...
        List<String> creativeLevelSQLList = executor.executeQuery(sqlFile, envt, "getCountCreativeDeliveryLevel", "$ColumnName$", "creative_id", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeDeliveryLevelCreative(reportStartDate, reportEndDate), token);
        ...
        Map<String, DestinationTable> mapper = etlUtil.getMapSet(System.getProperty("user.dir")+"/"+"Datorama_Creative_Hierarchcial.xlsx", "CreativeDelivery_CreativeID");
