 ...
 */
public class CreativeDeliveryCreativeHierarchy extends BaseClass {
    ...
    public void creativeLevelCampaignTest() throws Exception {
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeDeliveryLevelCreative(reportStartDate, reportEndDate, brandId), token);
