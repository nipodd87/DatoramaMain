...
public class DomainConversionSqlToS3  extends BaseClass  {
    ...
    public void domainConversionToS3() throws Exception {
        ...
        spRecordCount=executor.getStoreProcedureCount(storeProcFile, envt,"thirdPartyFileGeneration_DomainConversion", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
