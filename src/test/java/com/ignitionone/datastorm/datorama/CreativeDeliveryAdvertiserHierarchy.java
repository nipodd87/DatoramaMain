 ...
 */
public class CreativeDeliveryAdvertiserHierarchy extends BaseClass {

    private static final String REPORT_HEADER = "Creative Delivery: Hierarchical Level Test <BR> Measurement Sum Comparison Between SQL NAN And Datorama <BR> Group By:  ADVERTISER ID";
    ...
    @Test
    public void creativeLevelAdvertiserTest() throws Exception {
        ...
        List<String> creativeLevelSQLList = executor.executeQuery(sqlFile, envt, "getCreativeMeasurementByColumn", "$ColumnName$", "advertiser_id", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeDeliveryLevelAdvertiser(reportStartDate, reportEndDate, brandId), token);
        ...
        Map<String, DestinationTable> mapper = etlUtil.getMapSet(System.getProperty("user.dir")+"/"+"Datorama_Creative_Hierarchcial.xlsx", "CreativeDelivery_AdvertiserID");
