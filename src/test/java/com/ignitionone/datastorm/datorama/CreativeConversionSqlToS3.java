...
public class CreativeConversionSqlToS3  extends BaseClass  {
    ...
    public void creativeConversionToS3() throws Exception {
        ...
        spRecordCount=executor.getStoreProcedureCount(storeProcFile, envt,"thirdPartyFileGeneration_CreativeConversion", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
