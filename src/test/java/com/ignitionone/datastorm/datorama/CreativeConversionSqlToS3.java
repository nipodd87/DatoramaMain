 ...
 */
public class CreativeConversionSqlToS3  extends BaseClass  {

    protected String environment;
    String SOURCE_TABLE = "SQL Nan tables";
    String DESTINATION_TABLE = "Amazon S3 CSV Files";
    private final String REPORT_HEADER = "Creative Conversion SQL Nan to Amazon S3 Test Case 1 <BR> Verify File Status in Audit Log Table";
    ...
    @Test
    public void creativeConversionToS3() throws Exception {
        ...
        executor.executeThirdPartyFileInfo(sqlFile, envt, "getThirdPartyFileInfo", "$fileTypeID$", "2");
        ...
        List<String> spResultData = executor.getStoredProcedure(storeProcFile, envt,"thirdPartyFileGeneration_CreativeConversion", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
        ...
        extentReportUtil.startTest("Creative Conversion SQL Nan to Amazon S3 Test Case 2 <BR> Verify Record Count <BR> Source Table : " + "NAN Stat" + " and Destination Table : " + "Store Procedure", "Verify record count between Source Table: " + "NAN STAT table" + " and Destination Table : " + "Store Procedure");
        ...
        executor.getMeasurementCount(sqlFile, envt, "getMeasurementCountCreativeConversion", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
        ...
        extentReportUtil.startTest("Creative Conversion SQL Nan to Amazon S3 Test Case 4 <BR> Check the Sum of Measurements between SQL NAN Stat table and CSV file Generated", "Check sum of Impressions, Clicks and Costs");
        metrics= DatoramaCSVUtil.getCreativeConversionMeasurementTotal("CreativeConversionSummarizedData.csv", ',');
        ...
        extentReportUtil.startTest("Creative Conversion SQL Nan to Amazon S3 Test Case 6<BR> Compare first 100 rows between Store Procedure and Amazon S3 CSV file", "between Store Procedure and Amazon S3 file");
        List<String> creativeConversionS3List = DatoramaCSVUtil.getCreativeConversionCSVData("CreativeConversionSummarizedData.csv", ',', "|@|");

        //Reduce the List to Only 100 rows
        List<String> creativeConversionSPList200 = DatoramaNanETL.getFirstNRows(spResultData, 100);
        Map<String, DestinationTable> mapper = etlUtil.getMapSet(System.getProperty("user.dir")+"/"+"Datorama_Mapping.xlsx", "Creative_Conversion_S3_Mapper");
        recordLevel.verifySrcWithDestData(mapper, creativeConversionSPList200, creativeConversionS3List);
    }
