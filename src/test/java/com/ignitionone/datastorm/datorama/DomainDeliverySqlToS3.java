...
public class DomainDeliverySqlToS3 extends BaseClass {
    ...
    public void domainDeliveryToS3() throws Exception {
        ...
        spRecordCount=executor.getStoreProcedureCount(storeProcFile, envt,"thirdPartyFileGeneration_DomainDelivery", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
