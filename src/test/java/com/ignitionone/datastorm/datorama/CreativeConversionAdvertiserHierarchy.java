 ...
 */
public class CreativeConversionAdvertiserHierarchy extends BaseClass {
    private static final String REPORT_HEADER = "Creative Conversion: Hierarchical Level Test <BR> Measurement Sum Comparison Between SQL NAN And Datorama <BR> Group By: ADVERTISER ID";
    ...
    @Test
    public void creativeLevelAdvertiserTestNanToDatorama() throws Exception {
        ...
        List<String> creativeLevelSQLList = executor.executeQuery(sqlFile, envt, "getCountCreativeConversionLevelForAdvertiser", "$ColumnName$", "advertiser_id", "$START_DATE$", reportStartDate, "$END_DATE$", reportEndDate);
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeConversionLevelAdvertiser(reportStartDate, reportEndDate, brandId), token);
        ...
        Map<String, DestinationTable> mapper = etlUtil.getMapSet(System.getProperty("user.dir")+"/"+"Datorama_Creative_Hierarchcial.xlsx", "CreativeConv_Advertiser");
