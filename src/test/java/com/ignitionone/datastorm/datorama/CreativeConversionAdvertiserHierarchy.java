...
public class CreativeConversionAdvertiserHierarchy extends BaseClass {
    ...
    public void creativeLevelAdvertiserTestNanToDatorama() throws Exception {
        ...
        String Resp = APIUtil.getResportAsString("/query/execBatchQuery",APIRequestBodyGenerator.getCreativeConversionLevelAdvertiser(reportStartDate, reportEndDate), token);
