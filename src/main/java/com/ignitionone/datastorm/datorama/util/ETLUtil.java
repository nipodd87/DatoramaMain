...
public class ETLUtil {
    ...
    private void verifySrcDestinationDataBasedOnMapping(Map<String, DestinationTable> mapSet, String[] srcTableColumnsNames, String[] destTableColumnsNames, String[] srcValues, String[] destValues, String keyColumn) throws ParseException {
        ...
        for (int counter = 0; counter < srcTableColumnsNames.length; counter++) {
            ...
            if (mapSet.containsKey(columnUnderTest) && Arrays.asList(destTableColumnsNames).indexOf(mapSet.get(columnUnderTest).getColumnName()) >= 0){
                ...
                String info = "between source  :" + columnUnderTest + " and Destination  :" + destTableColumnsNames[destCounter] + " for KEY column " + keyColumn;
