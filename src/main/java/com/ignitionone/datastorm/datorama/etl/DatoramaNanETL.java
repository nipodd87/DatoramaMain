...
public class DatoramaNanETL extends SqlBaseClass {
    ...
    public void getMeasurementCounts(String sqlFile, String environment, String sqlQueryName, String oldString1, String newString1, String oldString2, String newString2) throws Exception {
        sqlSetup(sqlFile, sqlQueryName, environment);
