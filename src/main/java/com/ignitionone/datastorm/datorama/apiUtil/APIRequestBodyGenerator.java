...
public class APIRequestBodyGenerator {
    ...
    public static String getDomainDelivery(String startDate, String endDate, String brandId) {
        return "[{\"brandId\": \""+brandId+"\",\"dateRange\": \"CUSTOM\",\"startDate\": \"" + startDate + "\",\"endDate\": \"" + endDate + "\",\"measurements\":[{\"name\": \"Impressions\"},{\"name\": \"Clicks\"},{\"name\": \"Media Cost\"},{\"name\": \"Third Party Cost\"},{\"name\": \"Total Cost\"},{\"name\": \"Client Spend\"},{\"name\": \"3rd Party Rate\"},{\"name\": \"Client Rate Test\"}],\"dimensions\": [\"Day\",\"Advertiser ID\",\"Campaign ID\",\"Campaign\",\"Campaign Flight Start Date\",\"Campaign Flight End Date\",\"Account Manager ID\",\"Campaign Status\",\"Advertiser Source ID\",\"Advertiser Source\",\"Line Item ID\",\"Line Item\",\"Line Item Flight Start Date\",\"Line Item Flight End Date\",\"Line Item Status\",\"Creative ID\",\"Creative\",\"Message Group ID\",\"Message Group\",\"Placement Pixel Size\",\"Adserver Placement ID\",\"AdServer Placement\",\"Publisher ID\",\"Publisher\",\"Currency (Original)\",\"Domain\",\"Third_Party_CPM_Rate\",\"Client_dCPM_Rate\"],\"groupDimensionFilters\": [{\"vals\":[\"Display Delivery\"],\"dimension\":\"Data Set\",\"operator\": \"IN\"}],\"stringDimensionFilters\": [],\"stringDimensionFiltersOperator\": \"AND\",\"numberDimensionFiltersOperator\": \"AND\",\"numberMeasurementFilter\": [],\"sortBy\": \"Day\",\"sortOrder\": \"DESC\",\"topResults\": \"500\",\"groupOthers\": false,\"topPerDimension\": false,\"totalDimensions\": []}]";
    }
