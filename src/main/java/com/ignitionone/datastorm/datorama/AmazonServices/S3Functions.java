...
//~ Methods --------------------------------------------------------------------------------------------------------
    ...
    /*
             * Read and print the all the file contents present in the AWS Bucket.
                */
    ...
    /*
            * Read and print the all the file contents present in the AWS Bucket.
               */
    public void getFileContentWinthinBucket(String bucketName, AmazonS3 s3) throws IOException {
